here::i_am("code/get_env_data.R")
#'  @title get_env_data()
#'  @description
#'  This function downloads, extracts, and cleans the environmental data. With this function 
...
#'  @param type a string of 'SST' or 
#'
#'
get_trawl_data(type = NULL){
  if(type == 'SST'){
